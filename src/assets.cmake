...
function(generate_head_file_for_asset ${head_file} ${asset_file})
    ...
    file(APPEND ${head_file} "#include <string>\n")
    file(APPEND ${head_file} "\n")
    file(APPEND ${head_file} "\n")
    file(APPEND ${head_file} "namespace ${ns_name} {\n")
    file(APPEND ${head_file} "\n")
    file(APPEND ${head_file} "namespace Data {\n")
    file(APPEND ${head_file} "    extern const unsigned char ${var_name}[];\n")
    file(APPEND ${head_file} "}\n")
    file(APPEND ${head_file} "\n")
    file(APPEND ${head_file} "namespace Len {\n")
    file(APPEND ${head_file} "    static const size_t ${var_name} = ${file_size};\n")
    file(APPEND ${head_file} "}\n")
    file(APPEND ${head_file} "\n")
    file(APPEND ${head_file} "namespace StrView {\n")
    file(APPEND ${head_file} "    static const std::string_view ${var_name}(reinterpret_cast<const char *>(Data::${var_name}), Len::${var_name});\n")
    file(APPEND ${head_file} "}\n")
    file(APPEND ${head_file} "\n")
    file(APPEND ${head_file} "}\n") 
    file(APPEND ${head_file} "\n")
